...
In the example of GFX module, [QemuPkg/QemuVideoDxe/QemuVideoDxe.inf](https://github.com/microsoft/mu_tiano_platforms/blob/main/QemuPkg/QemuVideoDxe/QemuVideoDxe.inf) is updated
...
In the example of GFX module, this initial value is handled by [QemuQ35Pkg/ConfigKnobs/ConfigKnobs.inf](https://github.com/microsoft/mu_tiano_platforms/blob/main/Platforms/QemuQ35Pkg/ConfigKnobs/ConfigKnobs.inf),
...
In the example of GFX module, this translation and data application is also handled by [QemuQ35Pkg/ConfigKnobs/ConfigKnobs.inf](https://github.com/microsoft/mu_tiano_platforms/blob/main/Platforms/QemuQ35Pkg/ConfigKnobs/ConfigKnobs.inf).
...
This way, when [QemuPkg/QemuVideoDxe/QemuVideoDxe.inf](https://github.com/microsoft/mu_tiano_platforms/blob/main/QemuPkg/QemuVideoDxe/QemuVideoDxe.inf) enters the driver binding
